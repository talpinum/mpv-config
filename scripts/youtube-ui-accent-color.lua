...
local user_opts = {
    ...
    scalefullscreen = 1.3,      -- scaling of the controller when fullscreen
    ...
    seekbarheight = 8,
    seekbarhandlesize = 7.5,		 -- 0.5 less than seekbarheight to make it look like there's no handle
    seekbarpadding = 35,
    volumebarheight = 3,
    volumebarhandlesize = 2.5,
    ...
    language = "it",
    thumbpad = 1,               -- thumbnail border size
}
...
local language = {
    ["eng"] = {
        welcome = "{\\fnCantarell-Regular\\b1\\fs20\\1c&HFFFFFF&\\bord0.5\\3c&HFFFFFF&}\\N\\Nmpv media player\\N\\N{\\fs12\\b0\\1c&HFFFFFF&\\bord0}Drop files or URLs to play here",  -- this text appears when mpv starts
        off = "Off",
        unknown = "unknown",
        none = "none",
    ...
    ["it"] = {
        welcome = '{\\fnCantarell-Regular\\b1\\fs20\\1c&HFFFFFF&\\bord0.5\\3c&HFFFFFF&}\\N\\NLettore multimediale mpv\\N\\N{\\fs12\\b0\\1c&HFFFFFF&\\bord0}Trascina qui file o URL da riprodurre',
        off = "Off",
        unknown = "sconosciuto",
        none = "nullo",
        video_track = "Traccia video",
        video_tracks = "Tracce video",
...
function rgb_to_bgr(hex)
    local r = hex:sub(1, 2)
    local g = hex:sub(3, 4)
    local b = hex:sub(5, 6)
    return b .. g .. r  -- Reverse the order to get BGR
end

-- Function to extract the accent_bg_color from the GTK file
function get_accent_bg_color(filepath)
    local file = io.open(filepath, "r")
    if file then
        for line in file:lines() do
            local color = line:match("@define%-color%s+accent_bg_color%s+#(%x+);")
            if color then
                bgr_accent_color = rgb_to_bgr(color)
                file:close()
                return bgr_accent_color  -- Return immediately when the color is found
            end
        end
...
-- File path to GTK config
local gtk_config_path = os.getenv("HOME") .. "/.config/gtk-4.0/gtk.css"
local bgr_bg_color = get_accent_bg_color(gtk_config_path)

local osc_styles = {
    box = "{\\blur100\\bord0\\1c&H000000\\3c&H000000}",
    seekbar_bg = "{\\blur0\\bord0\\1c&HFFFFFF}",
    seekbar_fg = "{\\blur0\\bord0\\1c&H".. bgr_accent_color .."}",
    volumebar_bg = "{\\blur0\\bord0\\1c&HFFFFFF}",
    volumebar_fg = "{\\blur0\\bord0\\1c&HFFFFFF}",
    button = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&HFFFFFF}",
    timecode = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&H000000\\fs20}",
...
local icons = {
    ...
    cy_audio = "{\\p1}m 8 0 b 3.6 0 0 3.6 0 8 b 0 12.4 3.6 16 8 16 b 12.4 16 16 12.4 16 8 b 16 3.6 12.4 0 8 0 m 8 2 b 11.3 2 14 4.7 14 8 b 14 11.3 11.3 14 8 14 b 4.7 14 2 11.3 2 8 b 2 4.7 4.7 2 8 2 m 8 5 b 6.3 5 5 6.3 5 8 b 5 9.7 6.3 11 8 11 b 9.7 11 11 9.7 11 8 b 11 6.3 9.7 5 8 5 m 8 6 b 9.1 6 10 6.9 10 8 b 10 9.1 9.1 10 8 10 b 6.9 10 6 9.1 6 8 b 6 6.9 6.9 6 8 6 m 8 7 b 7.4 7 7 7.4 7 8 b 7 8.6 7.4 9 8 9 b 8.6 9 9 8.6 9 8 b 9 7.4 8.6 7 8 7 m 8 7{\\p0}",
    volume_mute = "{\\p1}m 10 5 b 9.7 5 9.5 5.1 9.3 5.3 b 8.9 5.7 8.9 6.3 9.3 6.7 l 10.6 8 l 9.3 9.3 b 8.9 9.7 8.9 10.3 9.3 10.7 b 9.7 11.1 10.3 11.1 10.7 10.7 l 12 9.4 l 13.3 10.7 b 13.7 11.1 14.3 11.1 14.7 10.7 b 15.1 10.3 15.1 9.7 14.7 9.3 l 13.4 8 l 14.7 6.7 b 15.1 6.3 15.1 5.7 14.7 5.3 b 14.5 5.1 14.3 5 14 5 b 13.7 5 13.5 5.1 13.3 5.3 l 12 6.6 l 10.7 5.3 b 10.5 5.1 10.3 5 10 5 m 10 5 m 7 1 b 6.7 1 6.4 1.1 6.2 1.4 l 3 5 l 2 5 b 0.9 5 0 5.8 0 7 l 0 9 b 0 10.1 0.9 11 2 11 l 3 11 l 6.2 14.6 b 6.4 14.9 6.7 15 7 15 m 7 1 {\\p0}",
    volume_over = "{\\p1}m 7 1 b 6.7 1 6.4 1.1 6.2 1.4 l 3 5 l 2 5 b 0.9 5 0 5.8 0 7 l 0 9 b 0 10.1 0.9 11 2 11 l 3 11 l 6.2 14.6 b 6.4 14.9 6.7 15 7 15 m 14 1 b 13.4 1 13 1.4 13 2 l 13 14 b 13 14.6 13.4 15 14 15 b 14.6 15 15 14.6 15 14 l 15 2 b 15 1.4 14.6 1 14 1 m 10 3 b 9.4 3 9 3.4 9 4 l 9 12 b 9 12.6 9.4 13 10 13 b 10.6 13 11 12.6 11 12 l 11 4 b 11 3.4 10.6 3 10 3 m 10 3{\\p0}",
}
...
function layouts()
    ...
    local btnW = 28
    local btnH = 26
    local tcW = 250 --cant understand why before it was osc_geo.w - 520. It's not broken now
    ...
    lo.slider.gap = 4
    lo.slider.pad = user_opts.seekbarpadding
    lo.slider.handle_size = user_opts.seekbarhandlesize
    lo.slider.bar_height = user_opts.seekbarheight
    ...
    lo.geometry = {x = user_opts.seekbarpadding + 202, y = btnY +2, an = 4, w = 80, h = btnH}
    lo.style = osc_styles.volumebar_fg
    lo.slider.gap = 3
    lo.slider.pad = 0
    lo.slider.handle_size = user_opts.volumebarhandlesize
    lo.slider.bar_height = user_opts.volumebarheight
    ...
    lo.geometry = {x = user_opts.seekbarpadding + 28, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("skipback")
    lo.geometry = {x = user_opts.seekbarpadding + 60, y = refY -30, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("playpause")
    lo.geometry = {x = user_opts.seekbarpadding + 88, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("skipfrwd")
    lo.geometry = {x = user_opts.seekbarpadding + 118, y = refY -30, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("pl_next")
    lo.geometry = {x = user_opts.seekbarpadding + 150, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    -- Timecode
    lo = add_layout("timecode")
    lo.geometry = {x = user_opts.seekbarpadding + 304, y = btnY +2, an = 4, w = tcW, h = btnH}
    lo.style = osc_styles.timecode
    lo.button.maxchars = tcW

    lo = add_layout("cy_audio")
    lo.geometry = {x = osc_geo.w - 90 - user_opts.seekbarpadding, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("cy_sub")
    lo.geometry = {x = osc_geo.w - 123 - user_opts.seekbarpadding, y = btnY -1, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    -- Subtitle marker QUI HO MODIFICATO LO.GEOMETRY BTNY +11
    lo = new_element("sub_marker", "box")
    lo.visible = (get_track("sub") > 0) and (osc_param.playresx >= 496)
    lo = add_layout("sub_marker")
    lo.geometry = {x = osc_geo.w - 123 - user_opts.seekbarpadding, y = btnY + 9, an = 5, w = 16, h = 1}
    lo.style = osc_styles.seekbar_fg

    lo = add_layout("volume")
    lo.geometry = {x = user_opts.seekbarpadding + 190, y = btnY +1, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("tog_fs")
    lo.geometry = {x = osc_geo.w - 28 - user_opts.seekbarpadding, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button

    lo = add_layout("tog_info")
    lo.geometry = {x = osc_geo.w - 60 - user_opts.seekbarpadding, y = btnY, an = 5, w = btnW, h = btnH}
    lo.style = osc_styles.button
end
...
function show_logo()
    ...
    local logo_x, logo_y = osd_w / 2, osd_h / 2 - 52
    
    local ass = assdraw.ass_new()
    
    -- Dimensioni fisse per il logo
    local logo_size = 120  -- Dimensione fissa del logo
    local text_size = 24    -- Dimensione fissa del testo
    
    -- Rettangolo che copre tutta la finestra con colore #242424
    ass:new_event()
    ass:pos(0, 0)  -- Posizione nell'angolo superiore sinistro
    ass:append('{\\1c&H242424&\\bord0}')
    ass:draw_start()
    ass:move_to(0, 0)  -- Inizia dall'angolo superiore sinistro
    ass:line_to(osd_w, 0)  -- Linea orizzontale fino al bordo destro
    ass:line_to(osd_w, osd_h)  -- Linea verticale fino al bordo inferiore destro
    ass:line_to(0, osd_h)  -- Linea orizzontale fino al bordo inferiore sinistro
    ass:line_to(0, 0)  -- Chiude il rettangolo
    ass:draw_stop()
    
    -- Primo cerchio (ridotto a un terzo)
    ass:new_event()
    ass:pos(logo_x, logo_y)
    ass:append('{\\1c&H8E348D&\\3c&H0&\\3a&H60&\\blur1\\bord0.5}')
    ass:draw_start()
    ass_draw_cir_cw(ass, 0, 0, logo_size/3)  -- Raggio ridotto a un terzo
    ass:draw_stop()

    -- Secondo cerchio (ridotto a un terzo)
    ass:new_event()
    ass:pos(logo_x, logo_y)
    ass:append('{\\1c&H632462&\\bord0}')
    ass:draw_start()
    ass_draw_cir_cw(ass, 2, -2, logo_size/4)  -- Raggio e offset ridotti a un terzo
    ass:draw_stop()

    -- Terzo cerchio (ridotto a un terzo)
    ass:new_event()
    ass:pos(logo_x, logo_y)
    ass:append('{\\1c&HFFFFFF&\\bord0}')
    ass:draw_start()
    ass_draw_cir_cw(ass, -1.33, 1.33, logo_size/6)  -- Raggio e offset ridotti a un terzo
    ass:draw_stop()

    -- Linea triangolo (ridotto a un terzo)
    ass:new_event()
    ass:pos(logo_x, logo_y)
    ass:append('{\\1c&H632462&\\bord&}')
    ass:draw_start()
    ass:move_to(-logo_size / 15, -logo_size / 15)  -- Coordinata ridotta a un terzo
    ass:line_to(logo_size / 12, logo_size / 30)  -- Coordinata ridotta a un terzo
    ass:line_to(-logo_size / 15, logo_size / 10)  -- Coordinata ridotta a un terzo
    ass:draw_stop()

    -- Testo di benvenuto
    ass:new_event()
    ass:pos(logo_x, logo_y + 50)  -- Ridotto a metà
    ass:an(8)
